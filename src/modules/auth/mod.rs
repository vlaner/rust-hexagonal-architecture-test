// NOTE: while modules must not import code from another modules, this file is composition root
// that defines transaction boundary between modules
// another approach would be essentially make cross module calls eventually consistent
